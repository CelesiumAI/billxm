...
'IMPORTANT: In phone scripts and dispute letters, do NOT reference specific state agencies (e.g. Texas Department of Insurance, Tennessee Department of Health). Instead reference: the Better Business Bureau (BBB), the Centers for Medicare & Medicaid Services (CMS), and "my state\'s Attorney General" generically.';
